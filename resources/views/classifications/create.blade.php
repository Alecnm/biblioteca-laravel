<!-- resources/views/classifications/create.blade.php -->
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Crear Nueva Clasificación') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('classifications.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="w-full px-3 py-2 border rounded-lg">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="text-red-500">{{ $message }}</span>
                            @enderror
                        </div>
